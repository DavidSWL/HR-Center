...
//
// Deliberately NOT included here (see CLAUDE.md / conversation with David):
//   - Form I-9 — required by federal law to live in a separate file, not
//     this system, so it is never reproduced here even blank.
//   - Form W-4 (2019 revision) and DE-4 — official IRS/EDD forms that go
//     stale every year; reproducing a frozen copy risks handing out an
//     outdated version. Print the current one from irs.gov / edd.ca.gov.
