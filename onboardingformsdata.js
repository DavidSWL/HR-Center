...
//
// Form W-4 (2019 revision) and DE 4 Rev. 55 (5-25) ARE included below
// (the 'w4form' and 'de4form' entries), at David's explicit request,
// despite being official IRS/EDD forms that go stale whenever those
// agencies issue a new revision — each carries an on-page warning to
// that effect. Re-transcribe from a current source PDF when either
// agency revises its form; a static page here can't update itself.
//
...
// -------------------------------------------------------------- 1b --
// Added at David's request even though it goes stale whenever the IRS
// revises it — this is the exact 2019-revision Form W-4 text from the
// source PDF. Re-transcribe from a current irs.gov PDF when the IRS
// issues a new revision; nothing here updates itself automatically.
{
  key: 'w4form',
  ...
  blocks: [
    { t: 'callout', en: 'This is the 2019 revision of Form W-4, exactly as it appeared in the source packet. The IRS redesigned this form after 2019 (no more "allowances"). Before using this, confirm with your accountant or irs.gov/FormW4 whether a newer version should be used instead — a static page in this app can\'t update itself when the IRS revises the form.',
      es: 'Esta es la revisión de 2019 del Formulario W-4, tal como aparecía en el paquete original. El IRS rediseñó este formulario después de 2019 (ya no usa "exenciones"). Antes de usarlo, confirme con su contador o en irs.gov/FormW4 si se debe usar una versión más reciente — una página estática en esta aplicación no puede actualizarse por sí sola cuando el IRS revisa el formulario.' },
    { t: 'section', en: 'Purpose & General Instructions', es: 'Propósito e Instrucciones Generales' },
    { t: 'p', en: 'Complete Form W-4 so that your employer can withhold the correct federal income tax from your pay. Consider completing a new Form W-4 each year and when your personal or financial situation changes.',
      es: 'Complete el Formulario W-4 para que su empleador pueda retener el impuesto federal sobre la renta correcto de su salario. Considere completar un nuevo Formulario W-4 cada año y cuando su situación personal o financiera cambie.' },
    { t: 'p', en: 'Exemption from withholding: You may claim exemption from withholding for 2019 if (1) for 2018 you had a right to a refund of all federal income tax withheld because you had no tax liability, and (2) for 2019 you expect a refund of all federal income tax withheld because you expect to have no tax liability. If you\'re exempt, complete only lines 1, 2, 3, 4, and 7 and sign the form to validate it. Your exemption for 2019 expires February 17, 2020.',
      es: 'Exención de retención: Puede reclamar exención de retención para 2019 si (1) en 2018 tuvo derecho a un reembolso de todo el impuesto federal retenido porque no tuvo obligación tributaria, y (2) para 2019 espera un reembolso de todo el impuesto federal retenido porque espera no tener obligación tributaria. Si está exento, complete únicamente las líneas 1, 2, 3, 4 y 7, y firme el formulario para validarlo. Su exención para 2019 vence el 17 de febrero de 2020.' },
    { t: 'p', en: 'If you aren\'t exempt, follow the rest of these instructions to determine the number of withholding allowances you should claim and any additional amount of tax to have withheld. You can also use the calculator at irs.gov/W4App to determine your tax withholding more accurately, especially if you have a working spouse, more than one job, or a large amount of nonwage income.',
      es: 'Si no está exento, siga el resto de estas instrucciones para determinar el número de exenciones de retención que debe reclamar y cualquier cantidad adicional de impuesto a retener. También puede usar la calculadora en irs.gov/W4App para determinar su retención de impuestos con mayor precisión, especialmente si tiene un cónyuge que trabaja, más de un empleo, o una gran cantidad de ingresos no salariales.' },
    { t: 'p', en: 'Filers with multiple jobs or working spouses should read the instructions for the Two-Earners/Multiple Jobs Worksheet before beginning. If you have a large amount of nonwage income not subject to withholding, consider making estimated tax payments using Form 1040-ES instead, or use the Deductions, Adjustments, and Additional Income Worksheet on page 3.',
      es: 'Las personas con múltiples empleos o cónyuges que trabajan deben leer las instrucciones de la Hoja de Trabajo para Dos Ingresos/Múltiples Empleos antes de comenzar. Si tiene una gran cantidad de ingresos no salariales no sujetos a retención, considere hacer pagos de impuestos estimados usando el Formulario 1040-ES, o use la Hoja de Trabajo de Deducciones, Ajustes e Ingresos Adicionales en la página 3.' },
    { t: 'section', en: 'Specific Instructions — Personal Allowances Worksheet', es: 'Instrucciones Específicas — Hoja de Trabajo de Exenciones Personales' },
    { t: 'p', en: 'Complete the Personal Allowances Worksheet on page 3 first to determine the number of withholding allowances to claim. Line C (head of household): generally you may claim this filing status only if you\'re unmarried and pay more than 50% of the costs of keeping up a home for yourself and a qualifying individual. Line E (child tax credit) and Line F (credit for other dependents) let you reduce the tax withheld from your pay to account for qualifying dependents — see the worksheet on page 3 for the income thresholds.',
      es: 'Complete primero la Hoja de Trabajo de Exenciones Personales en la página 3 para determinar el número de exenciones de retención a reclamar. Línea C (jefe de familia): generalmente puede reclamar este estado civil solo si no está casado y paga más del 50% de los costos de mantener un hogar para usted y una persona calificada. Las Líneas E (crédito tributario por hijos) y F (crédito por otros dependientes) le permiten reducir el impuesto retenido de su salario para tener en cuenta dependientes calificados — vea la hoja de trabajo en la página 3 para los umbrales de ingresos.' },
    { t: 'section', en: "Employee's Withholding Allowance Certificate — OMB No. 1545-0074 — 2019", es: 'Certificado de Exenciones de Retención del Empleado — OMB No. 1545-0074 — 2019' },
    { t: 'p', en: "Whether you're entitled to claim a certain number of allowances or exemption from withholding is subject to review by the IRS. Your employer may be required to send a copy of this form to the IRS.",
      es: 'Si usted tiene derecho a reclamar un cierto número de exenciones o la exención de retención está sujeto a revisión por el IRS. Es posible que su empleador deba enviar una copia de este formulario al IRS.' },
    { t: 'grid', cols: 2,
      cellsEn: [ { label: '1. Your first name and middle initial / Last name' }, { label: '2. Your social security number' },
        { label: 'Home address (number and street or rural route)', span: true }, { label: 'City or town, state, and ZIP code', span: true } ],
      cellsEs: [ { label: '1. Su primer nombre e inicial del segundo nombre / Apellido' }, { label: '2. Su número de seguro social' },
        { label: 'Dirección (número y calle o ruta rural)', span: true }, { label: 'Ciudad, estado y código postal', span: true } ] },
    { t: 'p', en: '3. Marital status: □ Single &nbsp; □ Married &nbsp; □ Married, but withhold at higher Single rate. Note: if married filing separately, check "Married, but withhold at higher Single rate."',
      es: '3. Estado civil: □ Soltero(a) &nbsp; □ Casado(a) &nbsp; □ Casado(a), pero retener a la tasa más alta de Soltero(a). Nota: si presenta la declaración por separado estando casado(a), marque "Casado(a), pero retener a la tasa más alta de Soltero(a)."' },
    { t: 'p', en: "4. If your last name differs from that shown on your social security card, check here. You must call 800-772-1213 for a replacement card. □",
      es: '4. Si su apellido difiere del que aparece en su tarjeta de seguro social, marque aquí. Debe llamar al 800-772-1213 para una tarjeta de reemplazo. □' },
    { t: 'grid', cols: 1,
      cellsEn: [ { label: "5. Total number of allowances you're claiming (from the applicable worksheet on the following pages)" },
        { label: '6. Additional amount, if any, you want withheld from each paycheck: $' },
        { label: '7. I claim exemption from withholding for 2019 (both conditions on page 1 must be met) — write "Exempt" here if so' } ],
      cellsEs: [ { label: '5. Número total de exenciones que está reclamando (de la hoja de trabajo aplicable en las páginas siguientes)' },
        { label: '6. Cantidad adicional, si la hay, que desea que se retenga de cada cheque de pago: $' },
        { label: '7. Reclamo exención de retención para 2019 (se deben cumplir ambas condiciones de la página 1) — escriba "Exento" aquí si es así' } ] },
    { t: 'fine', en: 'Under penalties of perjury, I declare that I have examined this certificate and, to the best of my knowledge and belief, it is true, correct, and complete. This form is not valid unless you sign it.',
      es: 'Bajo pena de perjurio, declaro que he examinado este certificado y, a mi mejor saber y entender, es verdadero, correcto y completo. Este formulario no es válido a menos que lo firme.' },
    { t: 'sig', fieldsEn: ["Employee's Signature", 'Date'], fieldsEs: ['Firma del Empleado', 'Fecha'] },
    { t: 'grid', cols: 3,
      cellsEn: [ { label: "8. Employer's name and address" }, { label: '9. First date of employment' }, { label: '10. Employer identification number (EIN)' } ],
      cellsEs: [ { label: '8. Nombre y dirección del empleador' }, { label: '9. Primera fecha de empleo' }, { label: '10. Número de identificación del empleador (EIN)' } ] },
    { t: 'section', en: 'Deductions, Adjustments, and Additional Income Worksheet', es: 'Hoja de Trabajo de Deducciones, Ajustes e Ingresos Adicionales' },
    { t: 'p', en: 'Complete this worksheet (page 3) to determine if you\'re able to reduce the tax withheld from your paycheck to account for itemized deductions and other adjustments to income, such as IRA contributions. It is optional — you\'re not required to complete it or reduce your withholding if you don\'t wish to.',
      es: 'Complete esta hoja de trabajo (página 3) para determinar si puede reducir el impuesto retenido de su cheque de pago para tener en cuenta las deducciones detalladas y otros ajustes a los ingresos, como las contribuciones a una cuenta IRA. Es opcional — no está obligado a completarla ni a reducir su retención si no lo desea.' },
    { t: 'section', en: 'Two-Earners/Multiple Jobs Worksheet', es: 'Hoja de Trabajo para Dos Ingresos/Múltiples Empleos' },
    { t: 'p', en: 'Complete this worksheet (page 4) if you have more than one job at a time or are married filing jointly and have a working spouse. Figure the total number of allowances you\'re entitled to claim on all jobs using worksheets from only one Form W-4 — claim all allowances on the W-4 for the highest-paying job and zero allowances on the W-4s for all other jobs. Tip: if you have a working spouse and your incomes are similar, you can check "Married, but withhold at higher Single rate" instead of using this worksheet.',
      es: 'Complete esta hoja de trabajo (página 4) si tiene más de un empleo a la vez o está casado(a) presentando una declaración conjunta y tiene un cónyuge que trabaja. Calcule el número total de exenciones que tiene derecho a reclamar en todos los empleos usando las hojas de trabajo de un solo Formulario W-4 — reclame todas las exenciones en el W-4 del empleo con el salario más alto y cero exenciones en los W-4 de los demás empleos. Consejo: si tiene un cónyuge que trabaja y sus ingresos son similares, puede marcar "Casado(a), pero retener a la tasa más alta de Soltero(a)" en lugar de usar esta hoja de trabajo.' },
    { t: 'fine', en: "Instructions for Employer: Employees do not complete boxes 8, 9, or 10 — the employer completes these if necessary for new-hire reporting to the State Directory of New Hires. Privacy Act and Paperwork Reduction Act Notice: this information is required by Internal Revenue Code sections 3402(f)(2) and 6109; failure to provide a properly completed form results in being treated as single with no withholding allowances. Generally, tax returns and return information are confidential as required by Code section 6103.",
      es: 'Instrucciones para el Empleador: Los empleados no completan las casillas 8, 9 o 10 — el empleador las completa si es necesario para el informe de nuevos empleados al Directorio Estatal de Nuevos Empleados. Aviso de la Ley de Privacidad y la Ley de Reducción de Trámites: esta información es requerida por las secciones 3402(f)(2) y 6109 del Código de Rentas Internas; no proporcionar un formulario debidamente completado resulta en ser tratado como soltero(a) sin exenciones de retención. En general, las declaraciones de impuestos y la información de las declaraciones son confidenciales según lo requiere la sección 6103 del Código.' },
    { t: 'section', en: 'Personal Allowances Worksheet (page 3) — keep for your records', es: 'Hoja de Trabajo de Exenciones Personales (página 3) — conserve para sus registros' },
    { t: 'table',
      headersEn: ['Line', 'Description', 'Enter'], headersEs: ['Línea', 'Descripción', 'Ingrese'],
      rows: [
        { en: ['A', 'Enter "1" for yourself'], es: ['A', 'Ingrese "1" para usted mismo(a)'] },
        { en: ['B', "Enter \"1\" if you will file as married filing jointly"], es: ['B', 'Ingrese "1" si presentará como casado(a) declarando conjuntamente'] },
        { en: ['C', 'Enter "1" if you will file as head of household'], es: ['C', 'Ingrese "1" si presentará como jefe de familia'] },
        { en: ['D', "Enter \"1\" if: you're single/married filing separately with only one job; or married filing jointly with only one job and spouse doesn't work; or wages from a second job/spouse's job total $1,500 or less"], es: ['D', 'Ingrese "1" si: es soltero(a)/casado(a) declarando por separado con un solo empleo; o casado(a) declarando conjuntamente con un solo empleo y el cónyuge no trabaja; o los salarios de un segundo empleo/del cónyuge suman $1,500 o menos'] },
        { en: ['E', 'Child tax credit — enter "4"/"2"/"1"/"-0-" for each eligible child depending on total income (see Pub. 972)'], es: ['E', 'Crédito tributario por hijos — ingrese "4"/"2"/"1"/"-0-" por cada hijo elegible según el ingreso total (vea la Pub. 972)'] },
        { en: ['F', 'Credit for other dependents — enter "1"/"-0-" per dependent depending on total income (see Pub. 972)'], es: ['F', 'Crédito por otros dependientes — ingrese "1"/"-0-" por dependiente según el ingreso total (vea la Pub. 972)'] },
        { en: ['G', 'Other credits — see Worksheet 1-6 of Pub. 505'], es: ['G', 'Otros créditos — vea la Hoja de Trabajo 1-6 de la Pub. 505'] },
        { en: ['H', 'Total — add lines A through G and enter here and on line 5 of Form W-4 (unless using the worksheets on pages 3-4)'], es: ['H', 'Total — sume las líneas A a G e ingrese aquí y en la línea 5 del Formulario W-4 (a menos que use las hojas de trabajo de las páginas 3-4)'] },
      ] },
    { t: 'section', en: 'Deductions, Adjustments, and Additional Income Worksheet (page 3)', es: 'Hoja de Trabajo de Deducciones, Ajustes e Ingresos Adicionales (página 3)' },
    { t: 'table', small: true,
      headersEn: ['Line', 'Description', 'Enter'], headersEs: ['Línea', 'Descripción', 'Ingrese'],
      rows: [
        { en: ['1', 'Estimate of 2019 itemized deductions (mortgage interest, charitable contributions, state/local taxes up to $10,000, medical expenses over 10% of income — see Pub. 505)'], es: ['1', 'Estimación de deducciones detalladas de 2019 (interés hipotecario, donaciones caritativas, impuestos estatales/locales hasta $10,000, gastos médicos superiores al 10% del ingreso — vea la Pub. 505)'] },
        { en: ['2', 'Standard deduction: $24,400 married filing jointly/qualifying widow(er); $18,350 head of household; $12,200 single/married filing separately'], es: ['2', 'Deducción estándar: $24,400 casado(a) declarando conjuntamente/viudo(a) calificado(a); $18,350 jefe de familia; $12,200 soltero(a)/casado(a) declarando por separado'] },
        { en: ['3', 'Subtract line 2 from line 1 (if zero or less, enter "-0-")'], es: ['3', 'Reste la línea 2 de la línea 1 (si es cero o menos, ingrese "-0-")'] },
        { en: ['4', '2019 adjustments to income, QBI deduction, additional standard deduction for age/blindness'], es: ['4', 'Ajustes a los ingresos de 2019, deducción QBI, deducción estándar adicional por edad/ceguera'] },
        { en: ['5', 'Add lines 3 and 4'], es: ['5', 'Sume las líneas 3 y 4'] },
        { en: ['6', 'Estimate of 2019 nonwage income not subject to withholding (dividends, interest)'], es: ['6', 'Estimación de ingresos no salariales de 2019 no sujetos a retención (dividendos, intereses)'] },
        { en: ['7', 'Subtract line 6 from line 5 (if zero, enter "-0-"; if less than zero, enter in parentheses)'], es: ['7', 'Reste la línea 6 de la línea 5 (si es cero, ingrese "-0-"; si es menor que cero, ingrese entre paréntesis)'] },
        { en: ['8', 'Divide line 7 by $4,200, drop any fraction'], es: ['8', 'Divida la línea 7 entre $4,200, descarte cualquier fracción'] },
        { en: ['9', 'Number from the Personal Allowances Worksheet, line H'], es: ['9', 'Número de la Hoja de Trabajo de Exenciones Personales, línea H'] },
        { en: ['10', 'Add lines 8 and 9 (if zero or less, enter "-0-") — enter on line 1 of the Two-Earners worksheet, or on Form W-4 line 5 if not using that worksheet'], es: ['10', 'Sume las líneas 8 y 9 (si es cero o menos, ingrese "-0-") — ingrese en la línea 1 de la hoja de trabajo de Dos Ingresos, o en la línea 5 del Formulario W-4 si no usa esa hoja de trabajo'] },
      ] },
    { t: 'section', en: 'Two-Earners/Multiple Jobs Worksheet (page 4)', es: 'Hoja de Trabajo para Dos Ingresos/Múltiples Empleos (página 4)' },
    { t: 'p', en: 'Use this worksheet only if the instructions under line H of the Personal Allowances Worksheet direct you here.', es: 'Use esta hoja de trabajo solo si las instrucciones bajo la línea H de la Hoja de Trabajo de Exenciones Personales lo indican.' },
    { t: 'table', small: true,
      headersEn: ['Line', 'Description', 'Enter'], headersEs: ['Línea', 'Descripción', 'Ingrese'],
      rows: [
        { en: ['1', 'Number from Personal Allowances Worksheet line H (or Deductions worksheet line 10, if used)'], es: ['1', 'Número de la línea H de la Hoja de Trabajo de Exenciones Personales (o línea 10 de la hoja de Deducciones, si se usó)'] },
        { en: ['2', 'Find the number in Table 1 below for the LOWEST paying job (cap of "3" applies in some cases — see table)'], es: ['2', 'Busque el número en la Tabla 1 abajo para el empleo de MENOR salario (aplica un tope de "3" en algunos casos — vea la tabla)'] },
        { en: ['3', 'If line 1 ≥ line 2, subtract line 2 from line 1 — enter here and on Form W-4 line 5. (If line 1 < line 2, enter "-0-" on Form W-4 line 5 and complete lines 4-9 below.)'], es: ['3', 'Si la línea 1 ≥ línea 2, reste la línea 2 de la línea 1 — ingrese aquí y en la línea 5 del Formulario W-4. (Si la línea 1 < línea 2, ingrese "-0-" en la línea 5 del Formulario W-4 y complete las líneas 4-9 abajo.)'] },
        { en: ['4', 'Number from line 2 of this worksheet'], es: ['4', 'Número de la línea 2 de esta hoja de trabajo'] },
        { en: ['5', 'Number from line 1 of this worksheet'], es: ['5', 'Número de la línea 1 de esta hoja de trabajo'] },
        { en: ['6', 'Subtract line 5 from line 4'], es: ['6', 'Reste la línea 5 de la línea 4'] },
        { en: ['7', 'Amount from Table 2 below for the HIGHEST paying job'], es: ['7', 'Cantidad de la Tabla 2 abajo para el empleo de MAYOR salario'] },
        { en: ['8', 'Multiply line 7 by line 6 — this is the additional annual withholding needed'], es: ['8', 'Multiplique la línea 7 por la línea 6 — esta es la retención anual adicional necesaria'] },
        { en: ['9', 'Divide line 8 by the number of pay periods remaining in 2019 — enter here and on Form W-4 line 6'], es: ['9', 'Divida la línea 8 entre el número de períodos de pago restantes en 2019 — ingrese aquí y en la línea 6 del Formulario W-4'] },
      ] },
    { t: 'table', small: true, headersEn: ['Table 1 — Married Filing Jointly: wages from LOWEST paying job', 'Enter on line 2'], headersEs: ['Tabla 1 — Casado(a) Declarando Conjuntamente: salarios del empleo de MENOR pago', 'Ingrese en la línea 2'],
      rows: [
        { en: ['$0 – $5,000', '0'], es: ['$0 – $5,000', '0'] }, { en: ['$5,001 – $9,500', '1'], es: ['$5,001 – $9,500', '1'] },
        { en: ['$9,501 – $19,500', '2'], es: ['$9,501 – $19,500', '2'] }, { en: ['$19,501 – $35,000', '3'], es: ['$19,501 – $35,000', '3'] },
        { en: ['$35,001 – $40,000', '4'], es: ['$35,001 – $40,000', '4'] }, { en: ['$40,001 – $46,000', '5'], es: ['$40,001 – $46,000', '5'] },
        { en: ['$46,001 – $55,000', '6'], es: ['$46,001 – $55,000', '6'] }, { en: ['$55,001 – $60,000', '7'], es: ['$55,001 – $60,000', '7'] },
        { en: ['$60,001 – $70,000', '8'], es: ['$60,001 – $70,000', '8'] }, { en: ['$70,001 – $75,000', '9'], es: ['$70,001 – $75,000', '9'] },
        { en: ['$75,001 – $85,000', '10'], es: ['$75,001 – $85,000', '10'] }, { en: ['$85,001 – $95,000', '11'], es: ['$85,001 – $95,000', '11'] },
        { en: ['$95,001 – $125,000', '12'], es: ['$95,001 – $125,000', '12'] }, { en: ['$125,001 – $155,000', '13'], es: ['$125,001 – $155,000', '13'] },
        { en: ['$155,001 – $165,000', '14'], es: ['$155,001 – $165,000', '14'] }, { en: ['$165,001 – $175,000', '15'], es: ['$165,001 – $175,000', '15'] },
        { en: ['$175,001 – $180,000', '16'], es: ['$175,001 – $180,000', '16'] }, { en: ['$180,001 – $195,000', '17'], es: ['$180,001 – $195,000', '17'] },
        { en: ['$195,001 – $205,000', '18'], es: ['$195,001 – $205,000', '18'] }, { en: ['$205,001 and over', '19'], es: ['$205,001 en adelante', '19'] },
      ] },
    { t: 'table', small: true, headersEn: ['Table 1 — All Others: wages from LOWEST paying job', 'Enter on line 2'], headersEs: ['Tabla 1 — Todos los Demás: salarios del empleo de MENOR pago', 'Ingrese en la línea 2'],
      rows: [
        { en: ['$0 – $7,000', '0'], es: ['$0 – $7,000', '0'] }, { en: ['$7,001 – $13,000', '1'], es: ['$7,001 – $13,000', '1'] },
        { en: ['$13,001 – $27,500', '2'], es: ['$13,001 – $27,500', '2'] }, { en: ['$27,501 – $32,000', '3'], es: ['$27,501 – $32,000', '3'] },
        { en: ['$32,001 – $40,000', '4'], es: ['$32,001 – $40,000', '4'] }, { en: ['$40,001 – $60,000', '5'], es: ['$40,001 – $60,000', '5'] },
        { en: ['$60,001 – $75,000', '6'], es: ['$60,001 – $75,000', '6'] }, { en: ['$75,001 – $85,000', '7'], es: ['$75,001 – $85,000', '7'] },
        { en: ['$85,001 – $95,000', '8'], es: ['$85,001 – $95,000', '8'] }, { en: ['$95,001 – $100,000', '9'], es: ['$95,001 – $100,000', '9'] },
        { en: ['$100,001 – $110,000', '10'], es: ['$100,001 – $110,000', '10'] }, { en: ['$110,001 – $115,000', '11'], es: ['$110,001 – $115,000', '11'] },
        { en: ['$115,001 – $125,000', '12'], es: ['$115,001 – $125,000', '12'] }, { en: ['$125,001 – $135,000', '13'], es: ['$125,001 – $135,000', '13'] },
        { en: ['$135,001 – $145,000', '14'], es: ['$135,001 – $145,000', '14'] }, { en: ['$145,001 – $160,000', '15'], es: ['$145,001 – $160,000', '15'] },
        { en: ['$160,001 – $180,000', '16'], es: ['$160,001 – $180,000', '16'] }, { en: ['$180,001 and over', '17'], es: ['$180,001 en adelante', '17'] },
      ] },
    { t: 'table', small: true, headersEn: ['Table 2 — Married Filing Jointly: wages from HIGHEST paying job', 'Enter on line 7'], headersEs: ['Tabla 2 — Casado(a) Declarando Conjuntamente: salarios del empleo de MAYOR pago', 'Ingrese en la línea 7'],
      rows: [
        { en: ['$0 – $24,900', '$420'], es: ['$0 – $24,900', '$420'] }, { en: ['$24,901 – $84,450', '$500'], es: ['$24,901 – $84,450', '$500'] },
        { en: ['$84,451 – $173,900', '$910'], es: ['$84,451 – $173,900', '$910'] }, { en: ['$173,901 – $326,950', '$1,000'], es: ['$173,901 – $326,950', '$1,000'] },
        { en: ['$326,951 – $413,700', '$1,330'], es: ['$326,951 – $413,700', '$1,330'] }, { en: ['$413,701 – $617,850', '$1,450'], es: ['$413,701 – $617,850', '$1,450'] },
        { en: ['$617,851 and over', '$1,540'], es: ['$617,851 en adelante', '$1,540'] },
      ] },
    { t: 'table', small: true, headersEn: ['Table 2 — All Others: wages from HIGHEST paying job', 'Enter on line 7'], headersEs: ['Tabla 2 — Todos los Demás: salarios del empleo de MAYOR pago', 'Ingrese en la línea 7'],
      rows: [
        { en: ['$0 – $7,200', '$420'], es: ['$0 – $7,200', '$420'] }, { en: ['$7,201 – $36,975', '$500'], es: ['$7,201 – $36,975', '$500'] },
        { en: ['$36,976 – $81,700', '$910'], es: ['$36,976 – $81,700', '$910'] }, { en: ['$81,701 – $158,225', '$1,000'], es: ['$81,701 – $158,225', '$1,000'] },
        { en: ['$158,226 – $201,600', '$1,330'], es: ['$158,226 – $201,600', '$1,330'] }, { en: ['$201,601 – $507,800', '$1,450'], es: ['$201,601 – $507,800', '$1,450'] },
        { en: ['$507,801 and over', '$1,540'], es: ['$507,801 en adelante', '$1,540'] },
      ] },
  ],
},

// -------------------------------------------------------------- 1c --
// Same caveat as the W-4 above: DE 4 Rev. 55 (5-25), exact text from the
// source PDF, added at David's request. Re-transcribe when EDD issues a
// new revision (check edd.ca.gov) — this page won't update itself.
{
  key: 'de4form',
  ...
  blocks: [
    { t: 'callout', en: 'This is DE 4 Rev. 55 (5-25), exactly as it appeared in the source packet. The EDD revises this form periodically (note the "Rev. 55" and "5-25" — May 2025 — in the form number). Before using this, confirm at edd.ca.gov whether a newer revision is current — a static page in this app can\'t update itself when the EDD revises the form.',
      es: 'Esta es la revisión DE 4 Rev. 55 (5-25), tal como aparecía en el paquete original. El EDD revisa este formulario periódicamente (note "Rev. 55" y "5-25" — mayo de 2025 — en el número de formulario). Antes de usarlo, confirme en edd.ca.gov si hay una revisión más reciente vigente — una página estática en esta aplicación no puede actualizarse por sí sola cuando el EDD revisa el formulario.' },
    { t: 'p', en: 'Complete this form so that your employer can withhold the correct California state income tax from your pay. As of January 1, 2020, the federal Form W-4 is used for federal withholding only — you must file this state DE 4 to determine the appropriate California PIT withholding. If you do not provide your employer a completed DE 4, your employer must use Single with Zero withholding allowance.',
      es: 'Complete este formulario para que su empleador pueda retener el impuesto estatal de California correcto de su salario. A partir del 1 de enero de 2020, el Formulario W-4 federal se usa únicamente para la retención federal — debe presentar este DE 4 estatal para determinar la retención correcta del impuesto sobre la renta personal (PIT) de California. Si no le proporciona a su empleador un DE 4 completado, su empleador deberá usar Soltero(a) con Cero exenciones de retención.' },
    { t: 'grid', cols: 2,
      cellsEn: [ { label: 'First, Middle, Last Name' }, { label: 'Social Security Number' },
        { label: 'Address', span: true }, { label: 'City' }, { label: 'State / ZIP Code' } ],
      cellsEs: [ { label: 'Nombre, Segundo Nombre, Apellido' }, { label: 'Número de Seguro Social' },
        { label: 'Dirección', span: true }, { label: 'Ciudad' }, { label: 'Estado / Código Postal' } ] },
    { t: 'p', en: 'Filing Status: □ Single or Married (with two or more incomes) &nbsp; □ Married (one income) &nbsp; □ Head of Household',
      es: 'Estado Civil: □ Soltero(a) o Casado(a) (con dos o más ingresos) &nbsp; □ Casado(a) (un ingreso) &nbsp; □ Jefe de Familia' },
    { t: 'grid', cols: 1,
      cellsEn: [
        { label: '1a. Number of Regular Withholding Allowances (Worksheet A)' },
        { label: '1b. Number of allowances from the Estimated Deductions (Worksheet B)' },
        { label: '1c. Total Number of Allowances you are claiming' },
        { label: '2. Additional amount, if any, you want withheld each pay period (Worksheet C): $' },
        { label: '3. I claim exemption from withholding for 2025, and I certify I meet both conditions for exemption. □' },
        { label: '4. I certify under penalty of perjury that I am not subject to California withholding under the Service Member Civil Relief Act, as amended by the Military Spouses Residency Relief Act and the Veterans Benefits and Transition Act of 2018. □' },
      ],
      cellsEs: [
        { label: '1a. Número de Exenciones de Retención Regulares (Hoja de Trabajo A)' },
        { label: '1b. Número de exenciones de las Deducciones Estimadas (Hoja de Trabajo B)' },
        { label: '1c. Número Total de Exenciones que está reclamando' },
        { label: '2. Cantidad adicional, si la hay, que desea que se retenga cada período de pago (Hoja de Trabajo C): $' },
        { label: '3. Reclamo exención de retención para 2025, y certifico que cumplo ambas condiciones de exención. □' },
        { label: '4. Certifico bajo pena de perjurio que no estoy sujeto(a) a la retención de California bajo la Ley de Alivio Civil para Miembros del Servicio, según enmendada por la Ley de Alivio de Residencia para Cónyuges Militares y la Ley de Beneficios y Transición para Veteranos de 2018. □' },
      ] },
    { t: 'fine', en: 'Under penalty of perjury, I certify that the number of withholding allowances claimed on this certificate does not exceed the number to which I am entitled or, if claiming exemption from withholding, that I am entitled to claim the exempt status.',
      es: 'Bajo pena de perjurio, certifico que el número de exenciones de retención reclamadas en este certificado no excede el número al que tengo derecho o, si reclamo exención de retención, que tengo derecho a reclamar el estado de exento.' },
    { t: 'sig', fieldsEn: ["Employee's Signature", 'Date'], fieldsEs: ['Firma del Empleado', 'Fecha'] },
    { t: 'section', en: "Employer's Section", es: 'Sección del Empleador' },
    { t: 'grid', cols: 2, cellsEn: [{ label: "Employer's Name and Address" }, { label: 'California Employer Payroll Tax Account Number' }],
      cellsEs: [{ label: 'Nombre y Dirección del Empleador' }, { label: 'Número de Cuenta de Impuestos de Nómina del Empleador de California' }] },
    { t: 'section', en: 'Worksheet A — Regular Withholding Allowances', es: 'Hoja de Trabajo A — Exenciones de Retención Regulares' },
    { t: 'table',
      headersEn: ['Line', 'Description', 'Enter'], headersEs: ['Línea', 'Descripción', 'Ingrese'],
      rows: [
        { en: ['A', 'Allowance for yourself — enter 1'], es: ['A', 'Exención para usted mismo(a) — ingrese 1'] },
        { en: ['B', 'Allowance for your spouse (if not separately claimed by your spouse) — enter 1'], es: ['B', 'Exención para su cónyuge (si no la reclama por separado) — ingrese 1'] },
        { en: ['C', 'Allowance for blindness — yourself — enter 1'], es: ['C', 'Exención por ceguera — usted mismo(a) — ingrese 1'] },
        { en: ['D', 'Allowance for blindness — your spouse (if not separately claimed) — enter 1'], es: ['D', 'Exención por ceguera — su cónyuge (si no la reclama por separado) — ingrese 1'] },
        { en: ['E', 'Allowance(s) for dependent(s) — do not include yourself or your spouse'], es: ['E', 'Exención(es) por dependiente(s) — no incluya a usted mismo(a) ni a su cónyuge'] },
        { en: ['F', 'Total — add lines A through E and enter on line 1a of the DE 4'], es: ['F', 'Total — sume las líneas A a E e ingrese en la línea 1a del DE 4'] },
      ] },
    { t: 'p', en: 'Married But Not Living With Your Spouse: you may check the "Head of Household" box if your spouse will not live with you at any time during the year; you will furnish over half the cost of maintaining a home for the year for yourself and a qualifying child/stepchild; and you will file a separate return for the year. Head of Household: you must be unmarried or legally separated and pay more than 50% of the costs of maintaining a home for yourself and your dependent(s).',
      es: 'Casado(a) Pero Sin Vivir Con Su Cónyuge: puede marcar la casilla "Jefe de Familia" si su cónyuge no vivirá con usted en ningún momento durante el año; usted aportará más de la mitad del costo de mantener un hogar durante el año para usted y un hijo/hijastro calificado; y presentará una declaración por separado durante el año. Jefe de Familia: debe estar soltero(a) o legalmente separado(a) y pagar más del 50% de los costos de mantener un hogar para usted y sus dependientes.' },
    { t: 'section', en: 'Worksheet B — Estimated Deductions', es: 'Hoja de Trabajo B — Deducciones Estimadas' },
    { t: 'p', en: 'Use this worksheet only if you plan to itemize deductions, claim certain adjustments to income, or have a large amount of nonwage income not subject to withholding. You may claim one additional withholding allowance for each $1,000 (or fraction) by which your estimated deductions exceed your standard deduction.',
      es: 'Use esta hoja de trabajo solo si planea detallar deducciones, reclamar ciertos ajustes a los ingresos, o tiene una gran cantidad de ingresos no salariales no sujetos a retención. Puede reclamar una exención de retención adicional por cada $1,000 (o fracción) en que sus deducciones estimadas excedan su deducción estándar.' },
    { t: 'table', small: true,
      headersEn: ['Line', 'Description'], headersEs: ['Línea', 'Descripción'],
      rows: [
        { en: ['1', 'Estimate of itemized deductions for this tax year (per FTB Form 540 schedules)'], es: ['1', 'Estimación de deducciones detalladas para este año fiscal (según los anexos del Formulario 540 de FTB)'] },
        { en: ['2', 'Standard deduction: $11,080 (married filing joint w/ 2+ allowances, unmarried HOH, or qualifying widow(er) w/ dependents) or $5,540 (single/married filing separately/dual income married/married with multiple employers)'], es: ['2', 'Deducción estándar: $11,080 (casado(a) declaración conjunta con 2+ exenciones, jefe de familia soltero(a), o viudo(a) calificado(a) con dependientes) o $5,540 (soltero(a)/casado(a) por separado/matrimonio con doble ingreso/casado(a) con múltiples empleadores)'] },
        { en: ['3', 'Subtract line 2 from line 1'], es: ['3', 'Reste la línea 2 de la línea 1'] },
        { en: ['4', 'Estimate of adjustments to income (alimony payments, IRA deposits)'], es: ['4', 'Estimación de ajustes a los ingresos (pagos de pensión alimenticia, depósitos IRA)'] },
        { en: ['5', 'Add line 4 to line 3'], es: ['5', 'Sume la línea 4 a la línea 3'] },
        { en: ['6', 'Estimate of nonwage income (dividends, interest income, alimony receipts)'], es: ['6', 'Estimación de ingresos no salariales (dividendos, ingresos por intereses, pensión alimenticia recibida)'] },
        { en: ['7', 'If line 5 > line 6, subtract line 6 from line 5 (if not, see line 9 below)'], es: ['7', 'Si la línea 5 > línea 6, reste la línea 6 de la línea 5 (si no, vea la línea 9 abajo)'] },
        { en: ['8', 'Divide line 7 by $1,000, round to nearest whole number — enter on line 1b of the DE 4; complete Worksheet C if needed'], es: ['8', 'Divida la línea 7 entre $1,000, redondee al número entero más cercano — ingrese en la línea 1b del DE 4; complete la Hoja de Trabajo C si es necesario'] },
        { en: ['9', 'If line 6 > line 5: enter the amount from line 6'], es: ['9', 'Si la línea 6 > línea 5: ingrese la cantidad de la línea 6'] },
        { en: ['10', 'Enter the amount from line 5'], es: ['10', 'Ingrese la cantidad de la línea 5'] },
        { en: ['11', 'Subtract line 10 from line 9 — then complete Worksheet C'], es: ['11', 'Reste la línea 10 de la línea 9 — luego complete la Hoja de Trabajo C'] },
      ] },
    { t: 'section', en: 'Worksheet C — Additional Tax Withholding and Estimated Tax', es: 'Hoja de Trabajo C — Retención de Impuestos Adicional e Impuesto Estimado' },
    { t: 'table', small: true,
      headersEn: ['Line', 'Description'], headersEs: ['Línea', 'Descripción'],
      rows: [
        { en: ['1', 'Estimate of total wages for the tax year'], es: ['1', 'Estimación de salarios totales para el año fiscal'] },
        { en: ['2', 'Estimate of nonwage income (line 6 of Worksheet B)'], es: ['2', 'Estimación de ingresos no salariales (línea 6 de la Hoja de Trabajo B)'] },
        { en: ['3', 'Add lines 1 and 2'], es: ['3', 'Sume las líneas 1 y 2'] },
        { en: ['4', 'Itemized or standard deduction (line 1 or 2 of Worksheet B, whichever is largest)'], es: ['4', 'Deducción detallada o estándar (línea 1 o 2 de la Hoja de Trabajo B, la que sea mayor)'] },
        { en: ['5', 'Adjustments to income (line 4 of Worksheet B)'], es: ['5', 'Ajustes a los ingresos (línea 4 de la Hoja de Trabajo B)'] },
        { en: ['6', 'Add lines 4 and 5'], es: ['6', 'Sume las líneas 4 y 5'] },
        { en: ['7', 'Subtract line 6 from line 3'], es: ['7', 'Reste la línea 6 de la línea 3'] },
        { en: ['8', 'Tax liability on the amount on line 7, using the tax rate schedules below'], es: ['8', 'Obligación tributaria sobre la cantidad de la línea 7, usando las tablas de tasas de impuestos abajo'] },
        { en: ['9', 'Personal exemptions (line F of Worksheet A × $163.90)'], es: ['9', 'Exenciones personales (línea F de la Hoja de Trabajo A × $163.90)'] },
        { en: ['10', 'Subtract line 9 from line 8'], es: ['10', 'Reste la línea 9 de la línea 8'] },
        { en: ['11', 'Any tax credits (see FTB Form 540)'], es: ['11', 'Cualquier crédito tributario (vea el Formulario 540 de FTB)'] },
        { en: ['12', 'Subtract line 11 from line 10 — this is your total tax liability'], es: ['12', 'Reste la línea 11 de la línea 10 — esta es su obligación tributaria total'] },
        { en: ['13', 'Tax withheld and estimated to be withheld during the year — ask your employer, multiply by pay periods remaining, and add to the amount already withheld'], es: ['13', 'Impuesto retenido y estimado a retener durante el año — pregunte a su empleador, multiplique por los períodos de pago restantes, y sume a la cantidad ya retenida'] },
        { en: ['14', 'Subtract line 13 from line 12 (if less than zero, you do not need additional withholding)'], es: ['14', 'Reste la línea 13 de la línea 12 (si es menor que cero, no necesita retención adicional)'] },
        { en: ['15', 'Divide line 14 by the number of pay periods remaining — enter on line 2 of the DE 4'], es: ['15', 'Divida la línea 14 entre el número de períodos de pago restantes — ingrese en la línea 2 del DE 4'] },
      ] },
    { t: 'fine', en: 'Note: your employer is not required to withhold the additional amount requested on line 2. These tables are for calculating Worksheet C, current for this tax year only — the exact bracket dollar amounts are printed on the source DE 4 and are omitted here for length; refer to the current DE 4 at edd.ca.gov for the exact tax rate schedules.',
      es: 'Nota: su empleador no está obligado a retener la cantidad adicional solicitada en la línea 2. Estas tablas son para calcular la Hoja de Trabajo C, vigentes solo para este año fiscal — las cantidades exactas de los tramos se imprimen en el DE 4 original y se omiten aquí por extensión; consulte el DE 4 actual en edd.ca.gov para las tablas exactas de tasas de impuestos.' },
  ],
},
